api = 'https://62ab4127bd0e5d29af0bd51d.mockapi.io/admin'
...
function cargarDatos() {
    ...
    .then(data => {
        ...
        data.forEach((element, index) => {
            ...
            col3.innerHTML = element.user;
            var col4 = document.createElement("TD");
            col4.innerHTML = element.rol;
            var col5 = document.createElement("TD");
            col5.innerHTML = `<a class="btn me-1 px-4" id="btnEditar" id="modificar" href="#" onclick="">
                                    Editar
                               </a>
...
document.getElementById("btnGuardar").addEventListener("click", (e) => {
    ...
    guardar(usuario)
        ...
        .then(data => {
            ...
            var col3 = document.createElement("TD");
            col3.innerHTML = data.user;
            var col4 = document.createElement("TD");
            col4.innerHTML = data.rol;
            var col5 = document.createElement("TD");
            col5.innerHTML = `<a class="btn me-1 my1 px-4" id="btnEditar" href="#" onclick="">
                                    Editar
                               </a>
