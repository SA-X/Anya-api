api = 'https://62ab4127bd0e5d29af0bd51d.mockapi.io/donacion'
...
function cargarDatos() {
    ...
    .then(data => {
        ...
        data.forEach((element, index) => {
            ...
            col2.innerHTML = element.numCuenta;
            var col3 = document.createElement("TD");
            col3.innerHTML = element.valor;
            var col4 = document.createElement("TD");
            col4.innerHTML = element.descripcion;
            var col5 = document.createElement("TD");
            col5.innerHTML = element.fecha;
...
document.getElementById("btnGuardar").addEventListener("click", (e) => {
    ...
    guardar(usuario)
        ...
        .then(data => {
            ...
            var col2 = document.createElement("TD");
            col2.innerHTML = data.numCuenta;
            var col3 = document.createElement("TD");
            col3.innerHTML = data.valor;
            var col4 = document.createElement("TD");
            col4.innerHTML = data.descripcion;
            var col5 = document.createElement("TD");
            col5.innerHTML = data.fecha;
            var col6 = document.createElement("TD");
            col6.innerHTML = `<a class="btn me-1 px-4" id="btnEditar" id="modificar" href="#" onclick="">
                                    Editar
                               </a>
                               <a class="btn px-3" id="paint" id="modificar" href="#" onclick="eliminar(${data.id})">  
                                    Eliminar
                               </a>`;
            row.appendChild(col1);
            row.appendChild(col2);
