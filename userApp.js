...
function cargarDatos() {
    ...
    .then(data => {
        ...
        data.forEach((element, index) => {
            ...
            col10.innerHTML = `<a class="btn me-1 my1 px-4" id="btnEditar" id="modificar" href="#" onclick="">
                                    Editar
                               </a>
                               <a class="btn mt-1 px-3" id="paint" id="modificar" href="#" onclick="eliminar(${element.id})">  
                                    Eliminar
                               </a>`;
...
document.getElementById("btnGuardar").addEventListener("click", (e) => {
    ...
    guardar(usuario)
        ...
        .then(data => {
            ...
            var col10 = document.createElement("TD");
            col10.innerHTML = `<a class="btn me-1 my1 px-4" id="btnEditar" href="#" onclick="">
                                    Editar
                               </a>
